...
this._iDisplayStart+this.aiDisplay.length:Math.min(this._iDisplayStart+this._iDisplayLength,this._iRecordsDisplay):this._iDisplayEnd};this.sInstance=this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"正在处理中...",
    sLengthMenu: "显示 _MENU_ 记录", sZeroRecords: "No matching records found", sEmptyTable: "No data available in table", sInfo: "显示 _START_ 到 _END_ 共 _TOTAL_ 条记录", sInfoEmpty: "Showing 0 to 0 of 0 entries", sInfoFiltered: "", sInfoPostFix: "", sSearch: "Search:", sUrl: "", oPaginate: { sFirst: "&nbsp;&nbsp;第一页&nbsp;&nbsp;", sPrevious: "上一页", sNext: "下一页", sLast: "最后一页" }, fnInfoCallback: null
