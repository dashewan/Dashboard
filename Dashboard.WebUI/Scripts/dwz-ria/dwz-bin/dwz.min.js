...
$("<div id='shield' style=\""+shieldStyle+"\"></div>").appendTo("body");}};})(jQuery);(function($){
$.extend($.fn,{
...
var navTab = {
    ...
    _closeTab: function (index) {
        ...
        if (document.frames[index - 1]) {
            document.frames[index - 1].focus();
        }
    },
    ...
    openTab: function (tabid, url, options) {
        ...
        if (iOpenIndex >= 0) {
            ...
            if ($.browser.msie) { document.frames[this._currentIndex - 1].focus(); }
        }
        this._init();
        this._scrollCurrent();
